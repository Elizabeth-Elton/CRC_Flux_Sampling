%% small script to run just the model knockdowns that I want in CCM model (adapted from Tavakoli et al 2025)
...
% Run the enzyme knockdowns. 
    ...
    disp(['Condition: ' 'KRAS CAF']);
    data_path = ['baselineData/WT_vs_KRAS_CAF_media/data.mat'];
    load(data_path);
