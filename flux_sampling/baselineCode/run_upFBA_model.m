...
fold_change_kras_data_lst = {'fold_change_kras_crc.csv', ...
    ...
    'fold_change_wt_caf.csv', ...
    'fold_change_kras_caf.csv'};
folder_path_prefix = '/Users/elizabethelton/Documents/MATLAB/GitHub/CRC-Cell-uFBA-Modeling/enzyme_knockdowns/baselineCode/apriltest/';   % set where you want to place the output files
