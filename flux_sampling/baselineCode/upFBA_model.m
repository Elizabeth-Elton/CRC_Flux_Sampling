...
function upFBA_model(init_value_data, fold_change_kras_data, fold_change_wt_data, folder_path, conditions, title_name, rate_vals)
    ...
    'M_gln_L_e <o=> M_gln_L_i',...  % ASCT2 (Gln transport)
...
%     'M_asp_L_m + M_gln_L_i -> M_asn_L_m + M_glu_L_m' % asparagine synthetase (AS)
    ...
    Model = addCOBRAConstraints(Model, {'HPI', 'G6PDH'}, 0, 'c', ...
        [1, -9], 'dsense', ['E']); %Lastly, a flux split between glycolysis and the PPP was constrained to be 90/10 based on a previous 13C tracing study performed in cancer cell lines
